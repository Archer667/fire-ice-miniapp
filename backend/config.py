...
# ---- حقوقِ روزانهٔ پادشاه/شورای کوچک — از خزانهٔ رد کیپ، به‌صورت طلا ----
# مقدارِ هرکدوم (هم حقوقِ خودِ پادشاه، هم هر کرسیِ شورای کوچک) در hierarchy.king_salary_rate
# و hierarchy.council_salary_rates ذخیره می‌شه — پیش‌فرضِ همه صفره، خودِ پادشاه/ملکه هروقت
# بخواد از تبِ دیپلماسی عوضش می‌کنه (حتی حقوقِ خودش را)
SALARY_CYCLE_DAYS = 1
# حقوقِ هر کرسیِ شورای کوچک را خودِ پادشاه/ملکه تعیین می‌کند (پیش‌فرض صفر = بدون حقوق)
