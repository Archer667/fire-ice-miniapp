...
# ---- جاسوسی — هزینه، شانس موفقیت (کاهش‌یافته با برج نگهبانیِ هدف)، بی‌آبرویی هنگام دستگیری ----
SPY_GOLD_COST = 50
SPY_MEN_COST = 5              # «جاسوس» از جمعیت کم می‌شود؛ اگر موفق باشد برمی‌گردد، اگر دستگیر شود نه
SPY_BASE_CHANCE = 75          # درصد
SPY_MIN_CHANCE = 20           # درصد — سقفِ دفاعیِ برج نگهبانی هرچقدر بالا برود، شانس صفر نمی‌شود
SPY_CHANCE_PER_WATCHTOWER = 3 # درصد کاهش شانس به‌ازای هر سطح برج نگهبانیِ هدف
