...
REGIONS = {
    ...
    "crown":  {"name": "کراون‌لندز", "special": ["گارد سرخ‌پوش", "شوالیهٔ تاج"],
...
SIEGE_EQUIPMENT = {
    ...
    "trebuchet":    {"name": "ترابوشه", "level": 3, "cost": {"gold": 500, "wood": 300, "stone": 120, "iron": 80}, "siege_power": 28, "slowdown": 0.07},
}
...
SEA_EDGES = {
    frozenset(e) for e in [
        ...
        ("آربور", "فیرکسل"), ("آربور", "اولد اوک"), ("آربور", "لمون وود"),
