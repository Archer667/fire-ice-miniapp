export const REGIONS_STATIC = {
  ...
  storm: { name: 'استورملندز', g: 'اس', special: ["جنگجوی طوفان", "سوار طوفان"],
    castles: ['برونزگیت','بلک هیون','رین هوس','فلوود','میست وود','نایت سانگ','های استک هال','کروز نست','گریفینز روست'],
  ...
  crown: { name: 'کراون‌لندز', g: 'کر', special: ['گارد سرخ‌پوش', 'شوالیهٔ تاج'],
    castles: ['آنتلرز','داسکندیل','دایر دن','روزبی','استون دنس'],
