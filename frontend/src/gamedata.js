export const REGIONS_STATIC = {
  ...
  iron: { name: 'جزایر آهن', g: 'جز', special: ["غارتگر آهن", "جنگجوی تبردار"],
    castles: [],
    ports: ['اورکمونت','اولد ویک','بلک تاید','سالت کلیف','فیرکسل','پایک','گریت ویک'] },
  river: { name: 'ریورلندز', g: 'ری', special: ["پیادهٔ رودخانه", "کماندار باتلاق"],
    castles: ['استونی سپت','اولد استونز','اکرون هال','این آو د نیلینگ من','تویینز','ریوران','ریونتری هال','سالت پنس','فیر مارکت','لرد هارویز تاون','هارنهال','هورن ویل','ویکندن','پینک میدن'],
    ports: ['تن تاورز','سیگارد','میدنپول'] },
  west: { name: 'وسترلندز', g: 'وس', special: ["پیادهٔ زره‌سنگین", "شوالیه لنیستری"],
    ...
    ports: ['بینفورت','لنیسپورت'] },
  reach: { name: 'ریچ', g: 'رچ', special: ["کماندار ریچ", "سوار زره‌دار ریچ"],
    castles: ['آپلندز','اشفورد','برایت واتر کیپ','بلک کذون','بیتتر بریج','تامبلتون','تری تاورز','سامرهال','سیدر هال','لانگ تیبل','هاروست هال','هانی هولت','هایگاردن','گرسسی ویل','گولدن گرو'],
    ports: ['آربور','اولد اوک','اولد تاون','باندالون'] },
  vale: { name: 'درهٔ آرین', g: 'در', special: ["نیزه‌دار کوهستان", "سوار دره"],
    castles: ['آیرون اوکس','استرانگ سانگ','اسنیک وود','اولد انکر','ایری','بلادی گیت','بیلیش کیپ','ران استون','ردفورت','لانگ بو هال','هارتز هوم','کولد واتر'],
    ports: ['لیتل سیستر','گالتاون'] },
  storm: { name: 'استورملندز', g: 'اس', special: ["جنگجوی طوفان", "سوار طوفان"],
    ...
    ports: ['استورمز اند','استون هلم','ایون فال هال','سلن اسپیر','گرین استون'] },
  dorne: { name: 'دورن', g: 'دو', special: ["نیزه‌دار دورنی", "سوار شن"],
    ...
    ports: ['استارفال','سالت شور','سان اسپیر','ویپینگ تاون','گاستون گری','گوست هیل','یرون وود'] },
...
const CASTLE_TRAVEL_EDGES = [
  ...
  ['ریوران', 'گولدن توث', 30],
  ['ریوران', 'این آو د نیلینگ من', 30],
  ['ریوران', 'اکرون هال', 10],
  ['ریوران', 'هورن ویل', 60],
  ['این آو د نیلینگ من', 'لرد هارویز تاون', 30],
