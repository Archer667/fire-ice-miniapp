export const REGIONS_STATIC = {
  ...
  river: { name: 'ریورلندز', g: 'ری', special: ['پیادهٔ رودخانه', 'کماندار باتلاق'],
    castles: ['ریورران','هارنهال','تویینز','سیگارد','راونتری','استون‌هج','آکورن هال','دارری'],
  ...
  reach: { name: 'ریچ', g: 'رچ', special: ['کماندار ریچ', 'سوار زره‌دار ریچ'],
    castles: ['های‌گاردن','هورن‌هیل','تارلی‌هال','بریج‌واتر','اشفورد','ردلیک','سان‌هوس'],
...
const CASTLE_TRAVEL_EDGES = [
  ...
  ['موت کلین', 'فلینت', 60], ['موت کلین', 'گری‌واتر واچ', 30], ['موت کلین', 'تویینز', 60],
  ...
  ['اولدتاون', 'بیتربریج', 60], ['های‌گاردن', 'اشفورد', 30], ['کریگ', 'ردلیک', 30],
  ...
  ['دارک‌لین هال', 'دراگون‌استون', 30], ['دراگون‌استون', 'کینگز لندینگ', 35],
  ...
  ['اشفورد', 'استارفال', 40], ['ردلیک', 'های‌گاردن', 20],
];
